...
export default function ViewBrands() {
  ...
  const openConfirm = (row: BrandRow) => setConfirm({ open: true, id: row.id || null, name: row.name });
  ...
  const columns: GridColDef<BrandRow>[] = [
    {
      field: 'logo',
      headerName: 'Logo',
      width: 110,
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
        ...
        <Button isLink href="/brands/add" isStartIcon startIcon={<IoBag />} variant="primary" color="primary">
          Add Brand
        </Button>
      </div>
